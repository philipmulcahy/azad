...
* Zip it up into a zip archive file this is because often gmail objects to the amazon authored javascript that'll be embedded in the pages that in turn are embedded in the json file.
